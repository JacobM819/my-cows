      ...
      <div className={"container"}>
        ...
        <div className={"row g-0"}>
          <div className="text-center mb-4">
            ...
            >
              <img
                src={`${process.env.PUBLIC_URL}/images/cow-icon.png`}
                alt="Add Cow"
                style={{ width: "80px" }}
              />
            </Button>
          ...
          <div className={"text-center mb-4"}>
            ...
            >
              <img
                src={`${process.env.PUBLIC_URL}/images/rip-icon.png`}
                alt="Kill Cow"
                style={{ width: "80px" }}
              />
            </Button>
          ...
          <div className={"text-center mb-4"}>
            ...
            >
              <img
                src={`${process.env.PUBLIC_URL}/images/revive-icon.png`}
                alt="Revive Cow"
                style={{ width: "70px" }}
              />
            </Button>
          ...
          <div className={"text-center mb-4"}>
            ...
            >
              <img
                src={`${process.env.PUBLIC_URL}/images/miracle-icon.png`}
                alt="Perform Miracle"
                style={{ width: "80px" }}
              />
            </Button>
